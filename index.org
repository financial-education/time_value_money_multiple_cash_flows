...
var calculate2 = function() {
  ...
  var fva2 = c2 * (Math.pow((1 + rate2), num2) - 1) / rate2;
  
  document.getElementById("out_fva2").innerHTML = fva2.toFixed(2);
  ...
  <div class="row">
    ...
    <div class="column">
      <table style="width:100%">
        <tr>
          <th align="left">Cash Flow per Period:</th>
          <th><input id="c2" value="100" style="width: 50px"></th>
        </tr>
        <tr>
          <th align="left">Number of Periods:</th>
    ...
    <div class="column">
    <p><b>Future Value of the Annuity: <span id="out_fva2"></span></b></p>
    </div>
